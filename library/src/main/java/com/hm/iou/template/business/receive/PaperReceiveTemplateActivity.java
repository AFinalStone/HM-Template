package com.hm.iou.template.business.receive;
...
public class PaperReceiveTemplateActivity extends BaseActivity {
    ...
    protected int getLayoutId() {
        return R.layout.template_activity_paper_receive_template;
    }
        ...
        mTopbarView.setOnMenuClickListener(new HMTopBarView.OnTopBarMenuClickListener() {
            ...
            public void onClickImageMenu() {
                Router.getInstance().buildWithUrl("hmiou://m.54jietiao.com/calculator/index")
                        .navigation(PaperReceiveTemplateActivity.this);
            }
        });
